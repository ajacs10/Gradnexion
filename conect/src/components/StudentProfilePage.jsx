...
function StudentProfilePage({ graduates, onStudentMovedToInternship, session }) {
  ...
  if (session?.role === 'company') {
    return (
      <main className="homepage-main page-shell student-profile-page-shell">
        <section className="student-profile-hero student-profile-hero-company">
          <div className="student-profile-company-layout">
            <div className="student-profile-company-content">
              <article className="student-profile-main-card">
                ...
                <div className="student-profile-company-summary">
              ...
              <div className="student-profile-detail-grid">
                <article>
                  <h3>Sobre mim</h3>
                  <p>{student.quote}</p>
                ...
                <article>
                  ...
                  <div className="student-skill-list">
                    {(student.skills?.length ? student.skills : ['Em desenvolvimento']).map((skill) => (
                      <span key={skill}>{skill}</span>
                    ))}
                  </div>
                </article>
